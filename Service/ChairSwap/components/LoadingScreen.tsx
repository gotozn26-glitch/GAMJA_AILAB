...
export function LoadingScreen() {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden bg-background-light dark:bg-background-dark">
      <header className="z-20 flex items-center justify-between border-b border-solid border-b-[#f3e7e7] bg-background-light/80 px-6 py-3 backdrop-blur-sm dark:border-b-[#3a1d1d] dark:bg-background-dark/80 lg:px-10">
      ...
      <main className="relative flex flex-1 items-center justify-center overflow-hidden">
        <div className="pointer-events-none absolute inset-0 flex select-none flex-col items-center p-8 opacity-30 blur-[2px] md:p-12 lg:p-20">
          <div className="w-full max-w-[800px] space-y-8">
            <div className="mb-8 h-12 w-3/4 rounded bg-gray-200 dark:bg-gray-800" />
        ...
        <div className="z-10 flex w-full max-w-md flex-col items-center px-6 text-center">
          <div className="relative mb-10">
            ...
            <div className="relative flex size-24 items-center justify-center rounded-full bg-white shadow-xl shadow-primary/10 ring-4 ring-primary/5 animate-bounce-chair dark:bg-[#331818]">
              <span className="material-symbols-outlined text-5xl text-primary">chair_alt</span>
            </div>
          </div>
          <div className="mb-8 min-h-[5rem] space-y-2">
            <h2 className="animate-pulse text-2xl font-bold tracking-tight text-[#1b0d0d] dark:text-white md:text-3xl">
              음악이 흐르고 있어요...
            </h2>
          ...
          <div className="mb-10 flex w-full max-w-[280px] flex-col gap-3">
            <div className="flex items-end justify-between px-1">
              ...
              <span className="text-xs font-medium text-gray-500 dark:text-gray-400">전송 완료</span>
            </div>
